...
$jumlahData = count(query("SELECT * FROM tbl_barang WHERE nama LIKE '%Tanaman Hias Meja%'"));
...
$tb_barang = query("SELECT * FROM tbl_barang WHERE nama LIKE '%Tanaman Hias Meja%' LIMIT $awalData, $jumlahDataPerHalaman");
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-lg-12">
						...
						<ol class="breadcrumb">
							<li>
								<i class="fa fa-male" style="padding-right: 10px"></i>Bunga Mati
							</li>
							<li class="active">
								Tanaman Hias Meja
							</li>
                     	...
                     	<div class="thumbnail" style="background-color: light; border: 1px solid light; padding: 10px; box-shadow: 5px 10px 8px #CFCFCF; ">
                            <div class="col-in row">
                                <div class="col-md-12 col-sm-12 col-xs-12"> <i class="linea-icon linea-basic" data-icon="&#xe01b;"></i>
                                    <h5 class="text-center text-muted vb">Total Dana TanamanHias Meja</h5>
                                </div>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="panel panel-default">
							<div class="panel-heading"><h3>Tanaman Hias Meja</h3></div>
							<div class="panel-body">
								<center><h2 style="color: red;">Produk Tanaman Hias Meja</h2></center><br>
 ...
 -->
								...
								<!-- navigasi -->
										<ul class="pagination">
											...
											<a href="print.php" style="margin-left: 20px;"><button class="btn btn-danger"><i class="fa fa-print" style="padding-right: 5px;"></i>Cetak</button></a>

											<form method="post" action="excel.php" style="margin-left: 270px; margin-top: -34px;">
