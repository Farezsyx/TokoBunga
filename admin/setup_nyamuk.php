...
$jumlahData = count(query("SELECT * FROM tbl_barang WHERE nama LIKE '%nyamuk%'"));
...
$tlb_barang = query("SELECT * FROM tbl_barang WHERE nama LIKE '%nyamuk%' LIMIT $awalData, $jumlahDataPerHalaman");
				...
				<div class="row">
					<div class="col-md-12">
						<div class="panel panel-default">
							<div class="panel-heading"><h3>Tanaman Penghusir Nyamuk</h3></div>

							<div class="panel-body">
								<center><h2 style="color: red;">Produk Tanaman Penghusir Nyamuk</h2></center><br>
