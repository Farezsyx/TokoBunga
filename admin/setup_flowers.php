...
$jumlahData = count(query("SELECT * FROM tbl_barang WHERE nama LIKE '%flowers%'"));
...
$t_barang = query("SELECT * FROM tbl_barang WHERE nama LIKE '%flowers%' LIMIT $awalData, $jumlahDataPerHalaman");


$jmbarang = query("SELECT SUM(harga) as harga FROM tbl_barang WHERE nama LIKE '%bouquet%'");

$jmbarang1 = query("SELECT SUM(harga) as harga FROM tbl_barang WHERE nama LIKE '%nyamuk%'");

$jmbarang2 = query("SELECT SUM(harga) as harga FROM tbl_barang WHERE nama LIKE '%flowers%'");

// jika tombol cari ditekan
if (isset($_POST["cari"])) {
	$t_barang = cari($_POST["keyword"]);
}
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-lg-12">
						...
						<ol class="breadcrumb">
							<li>
								<i class="fa fa-female" style="padding-right: 10px"></i>Bunga Hidup
							</li>
							<li class="active">
								Macam Macam Bunga
							</li>
             ...
             <div class="row">
                     	...
                     	<div class="thumbnail" style="background-color: light; border: 1px solid light; padding: 10px; box-shadow: 5px 10px 8px #CFCFCF; ">
                            <div class="col-in row">
                                <div class="col-md-12 col-sm-12 col-xs-12"> <i class="linea-icon linea-basic" data-icon="&#xe01b;"></i>
                                    <h5 class="text-center text-muted vb">Total Dana Bouquet</h5>
                                </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                     	<div class="thumbnail" style="background-color: light; border: 1px solid light; padding: 10px; box-shadow: 5px 10px 8px #CFCFCF; ">
                            <div class="col-in row">
                                <div class="col-md-12 col-sm-12 col-xs-12"> <i class="linea-icon linea-basic" data-icon="&#xe01b;"></i>
                                    <h5 class="text-center text-muted vb">Total Dana Tanaman Penghusir Nyamuk</h5>
                                </div>
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="progress" style="height: 5px;">
                ...
                <?php foreach( $jmbarang2 as $row ) :?>
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                     	<div class="thumbnail" style="background-color: light; border: 1px solid light; padding: 10px; box-shadow: 5px 10px 8px #CFCFCF; ">
                            <div class="col-in row">
                                <div class="col-md-12 col-sm-12 col-xs-12"> <i class="linea-icon linea-basic" data-icon="&#xe01b;"></i>
                                    <h5 class="text-center text-muted vb">Total Dana Macam Macam Bunga</h5>
                                </div>
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="progress" style="height: 5px;">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="panel panel-default">
							<div class="panel-heading"><h3>Macam Macam Bunga</h3></div>

							<div class="panel-body">
								<center><h2 style="color: red;">Macam Macam Produk Bunga</h2></center><br>
 ...
 -->
										...
										<?php foreach( $t_barang as $row ) : ?>
											<tr class="text-center">
												...
												<td>
													...
													<a onclick="return confirm('Yakin akan menghapus ini?')" href="hapus.php?id=<?= $row["id"]; ?>"><button type="submit" class="btn btn-danger btn-sm" name="hapus" style="margin-top: 4px;">Hapus</button></a>
												</td>
											</tr>
											<?php $i++; ?>
										<?php endforeach; ?>
								...
								<!-- navigasi -->
										<ul class="pagination">
											...
											<a href="print3.php" style="margin-left: 20px;"><button class="btn btn-danger"><i class="fa fa-print" style="padding-right: 5px;"></i>Cetak</button></a>

											<form method="post" action="excel3.php" style="margin-left: 270px; margin-top: -34px;">
