                    ...
                    <tr class="text-center">
                        ...
                        <td><?= $row["password"] ;?></td>
                         ...
                         <td>                     
                          ...
                          <a onclick="return confirm('Yakin akan menghapus ini?')" href="setep.php?id=<?= $row["id"]; ?>"><button type="submit" class="btn btn-danger btn-sm" name="gosok" style="margin-top: -0px;">Hapus</button></a>
