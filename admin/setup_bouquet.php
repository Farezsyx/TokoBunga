...
$jumlahData = count(query("SELECT * FROM tbl_barang WHERE nama LIKE '%bouquet%'"));
...
$tl_barang = query("SELECT * FROM tbl_barang WHERE nama LIKE '%bouquet%' LIMIT $awalData, $jumlahDataPerHalaman");
				...
				<div class="row">
					<div class="col-md-12">
						<div class="panel panel-default">
							<div class="panel-heading"><h3>Bouquet</h3></div>

							<div class="panel-body">
								<center><h2 style="color: red;">Produk Bouquet</h2></center><br>
								...
								<!-- navigasi -->
										<ul class="pagination">
											...
											<a href="print4.php" style="margin-left: 20px;"><button class="btn btn-danger"><i class="fa fa-print" style="padding-right: 5px;"></i>Cetak</button></a>

											<form method="post" action="excel4.php" style="margin-left: 270px; margin-top: -34px;">
