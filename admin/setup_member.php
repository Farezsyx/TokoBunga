                   ...
                   <table class="table table-hover table-striped table-bordered" id="myTable">
                    ...
                    <tr class="text-center">
                        ...
                        <td>
                          ...
                          <a onclick="return confirm('Yakin akan menghapus ini?')" href="gosok.php?id=<?= $row["id"]; ?>"><button type="submit" class="btn btn-danger btn-sm" name="gosok" style="margin-top: -0px;">Hapus</button></a>

                          <a href="nambah.php?id=<?= $row["id"]; ?>"><button type="submit" class="btn btn-primary btn-sm" name="nambah" style="float: right; margin-bottom: 20px;"><i class="fa fa-user-plus" style="padding-right: 5px;"></i>Tambah</button></a>
                        </td>
                      </tr>
