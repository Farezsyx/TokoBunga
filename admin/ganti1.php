...
$mhs = query("SELECT * FROM tb_admin WHERE id = $id")[0];
	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			...
			<div class="container-fluid">
				...
				<!-- page table -->
				<form method="post">
					<center><h2 style="color: blue;">Ubah Admin</h2></center><br>
                  <fieldset>
                    <div class="row">
                      <div class="col-md-8">
                        <div class="form-group">
                          ...
                          <input class="form-control" name="password" type="text" value="<?= $mhs["password"] ?>">
                          <br>
                          <div class="btn-group">
                            <button onclick="return confirm('Yakin akan mengubah data ini?')" type="submit" name="submit" class="btn btn-warning">Ubah</button>
                          </div>
                        </div>
                      </div>
