...
.close:hover, .close:focus {
  ...
  <div class="container">
        ...
        <li class="dropdown">
         ...
         <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="hias.php">Tanaman Hias</a></li>
    ...
    <div class="rubypedia-parallax">
      <div class="container" style="text-align: center;padding-top: 160px">
        <div class="row">
          ...
          <span class="border" style="font-weight: bold; color: purple; padding: 18px;font-size: 60px;letter-spacing: 10px;">Deci Florist</span><br><br><br>
          <span class="border" style="background-color: #111;color: #fff;padding: 18px;font-size: 25px;letter-spacing: 10px;">We Make Your Day</span>
        </div>
      </div>
    </div>
    ...
    <div class="bs-callout bs-callout-primary">
      <h4>Deci Florist</h4>
      <p>
          Kami adalah toko bunga online terlengkap dan terpercaya, dengan harga terjangkau anda sudah dapat memiliki produk kami. Selamat Berbelanja Customer..
        </p>
            <p><a class="btn btn-primary btn-large" href="login_form.php">Mulai Berbelanja &raquo;</a></p>
    </div>
    ...
    <section class="home" id="home">
     ...
     <!-- Bunga mati -->
    <section class="bungamati" id="bungamati">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h2 class="text-center">Bunga Mati</h2>
            <hr>
          </div>
        </div>
                  ...
                  <div class="products-slick" data-nav="#slick-nav-2">
                    ...
                    <div class="product" >
                      ...
                      <div class="product-body">
                        <p class="product-category">Bunga Mati</p>
    ...
    <!-- Bunga hidup -->
    <div class="bungahidup" id="bungahidup">
        <div class="section">
          <!-- container -->
          <div class="container">

            <div class="col-md-12">
                <h2 class="text-center">Bunga Hidup</h2>
                <hr>
                <br>
              </div>
            <!-- row -->
            <!-- <div class="row"> -->
              <div class="col-md-4">
                <div class="section-title">
                  <h4 class="title">Macam Macam Bunga</h4>
                  <div class="section-nav">
                    <a href="flowers.php">Lihat Aneka Bunga...</a>
                  </div>
                </div>
                    ...
                    <div class="product-widget">
                      ...
                      <div class="product-body">
                        <p class="product-category">Bunga Hidup</p>
                        <h3 class="product-name"><a href="detailproduk.php?kd=<?php echo $row['id'];?>"><?php echo $row['nama']; ?></a></h3>
                        <h4 class="product-price">Rp.<?php echo number_format($row['harga']);?></h4>
                      </div>
                    </div>
              ...
              <div class="col-md-4">
                <div class="section-title">
                  <h4 class="title">Tanaman Penghusir Nyamuk</h4>
                  <div class="section-nav">
                    <a href="nyamuk.php">Lihat Tanaman...</a>
                  </div>
                </div>
              ...
              <div class="col-md-4">
                <div class="section-title">
                  <h4 class="title">Bouquet</h4>
                  <div class="section-nav">
                    <a href="bouquet.php">Lihat Aneka Bouquet...</a>
                  </div>
                </div>
          ...
          <div class="row">
            <div class="col-md-12 text-center">
              ...
              <span class="copyright">
                ...
                Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved <i class="fa fa-heart" style="color: #f66767;"></i> by <a href="admin/beranda.php" target="_blank">Dinda Deci Sunya</a>
              <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
              </span>
            </div>
          </div>
